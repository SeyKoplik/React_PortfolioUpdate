...
function About() {
  return (
    ...
    <p>Seychelle Koplik is a web development and coding bootcamp student based in Philadelphia, PA. Born in the Philippines, grew up in Chicago, and recent transplant to Philadelphia. Formerly a Chef with highly adaptable creative skills and passionate drive. Seychelle departed the fast-paced and intensely hot kitchens with a decade long experience and varying progressive skills within the culinary industry.</p>
    <p>Striving for career success in the field of Web Development. Eager to learn and absorb new frontier of technology. Yearning to be able to provide elegant, sleek, understandable coding. Excited to deliver service to provide clients with the highest of expectations for whatever web development needs that may arise. Seeking to beautify, inform, and enhance user experience via design and technology.</p>
